...
contract MO { // Modus Operandi...
    ...
    function _swap(uint amount0, uint amount1,
        ...
        } else if (delta < 0) { // TODO comment out block.timestamp for Taiko deploy
    ...
    function withdraw(uint amount, 
        ...
        if (quid) { // amount is in units of QD...
            ...
            uint128 liquidity = LiquidityAmounts.getLiquidityForAmounts(
                ...
                TickMath.getSqrtPriceAtTick(UPPER_TICK), FullMath.mulDiv(
                    price, transfer / 2, WAD * 1e12), transfer / 2
            ); 
