...
// import {ISwapRouter} from "../src/interfaces/ISwapRouter.sol"; // TODO used for mainnet forking
import {IV3SwapRouter} from "../src/interfaces/IV3SwapRouter.sol"; // used on Base and Taiko...
...
contract Deploy is Script {
    ...
    ERC4626 public SUSDE = ER4626(0x211Cc4DD073734dA055fbF44a2b4667d5E5fE5d2); 
    ...
    function run() public {
        ...
        quid = new Quid(address(moulinette), 
            ...
            address(quid)); moulinette.set_price_eth(false, true);
