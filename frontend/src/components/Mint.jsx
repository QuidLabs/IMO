...
export const Mint = () => {
  ...
  const { getTotalSupply, setStorage, addressQD, addressSDAI, account, connected, currentPrice, notifications, quid, sdai, mo, addressMO } = useAppContext()
